...
async function main() {
    ...
    const holidays = [
        ...
        { name: 'Araw ng Kagitingan', date: new Date('2026-04-09'), type: 'REGULAR' },
        { name: 'Maundy Thursday', date: new Date('2026-03-26'), type: 'REGULAR' },
        { name: 'Good Friday', date: new Date('2026-03-27'), type: 'REGULAR' },
        { name: 'Labor Day', date: new Date('2026-05-01'), type: 'REGULAR' },
        { name: 'Independence Day', date: new Date('2026-06-12'), type: 'REGULAR' },
        { name: 'National Heroes Day', date: new Date('2026-08-31'), type: 'REGULAR' },
        { name: 'Bonifacio Day', date: new Date('2026-11-30'), type: 'REGULAR' },
        { name: 'Christmas Day', date: new Date('2026-12-25'), type: 'REGULAR' },
        { name: 'Rizal Day', date: new Date('2026-12-30'), type: 'REGULAR' },
        { name: 'Ninoy Aquino Day', date: new Date('2026-08-21'), type: 'SPECIAL_NON_WORKING' },
        { name: "All Saints' Day", date: new Date('2026-11-01'), type: 'SPECIAL_NON_WORKING' },
        { name: 'Christmas Eve', date: new Date('2026-12-24'), type: 'SPECIAL_NON_WORKING' },
        { name: "New Year's Eve", date: new Date('2026-12-31'), type: 'SPECIAL_NON_WORKING' },
    ];
