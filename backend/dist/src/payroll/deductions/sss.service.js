...
exports.SSSService = void 0;
const common_1 = require("@nestjs/common");
let SSSService = class SSSService {
    SSS_BRACKETS = [
    ...
    getMonthlySalaryCredit(monthlyCompensation) {
        if (monthlyCompensation <= 0)
            return 5000;
        const bracket = this.SSS_BRACKETS.find((b) => monthlyCompensation >= b.minCompensation &&
            monthlyCompensation <= b.maxCompensation);
        return bracket ? bracket.monthlySalaryCredit : 35000;
    }
};
exports.SSSService = SSSService;
exports.SSSService = SSSService = __decorate([
    (0, common_1.Injectable)()
], SSSService);
//# sourceMappingURL=sss.service.js.map