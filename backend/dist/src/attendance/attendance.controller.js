...
let AttendanceController = class AttendanceController {
    ...
    async clockIn(body, req) {
        return this.attendanceService.clockIn(req.user.sub, body.latitude, body.longitude);
    }
    async clockOut(body, req) {
        return this.attendanceService.clockOut(req.user.sub, body.latitude, body.longitude);
    }
    async getTodayStatus(req) {
        return this.attendanceService.getTodayStatus(req.user.sub);
    }
    async getHistory(req, startDate, endDate) {
        return this.attendanceService.getHistory(req.user.sub, startDate ? new Date(startDate) : undefined, endDate ? new Date(endDate) : undefined);
    }
    async getStats(startDate, endDate) {
        return this.attendanceService.getAttendanceStats(startDate ? new Date(startDate) : undefined, endDate ? new Date(endDate) : undefined);
    }
};
